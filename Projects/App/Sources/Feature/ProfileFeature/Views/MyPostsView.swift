...
struct MyPostsView: View {
    ...
    let items: [PostItem] = [
        PostItem(imageName: "TestImage1", title: "바퀴벌레 좀 잡아주세요", point: 3000, category: "서비스"),
        PostItem(imageName: "TestImage2", title: "집 청소좀 해주세요", point: 3000, category: "서비스"),
        PostItem(imageName: "TestImage3", title: "자전거 팔아요", point: 5000, category: "팔아요")
    ]

    var filteredItems: [PostItem] {
